# FoLocal — 本地优先的 RSS 桌面阅读器

> [!IMPORTANT]
> FoLocal 是一个独立的开源项目，代码基于 [RSSNext/Folo](https://github.com/RSSNext/Folo)
> （AGPL-3.0）构建并做了大量本地化改造，与 RSSNext 或 Folo 官方无关，也未获得其背书。
>
> - 本仓库：<https://github.com/Guyungy/Folo-Local>
...
- 内置 RSSHub 实例池：路由与实例解耦，实例故障时自动切换，可在设置中管理、
  探活和重置实例，并提供超时和错误说明。
...
- 本地版暂时禁用自动更新；请从本仓库 Release 手动更新。
...
本地化改造始于 2026 年 9 月，主要实现集中在：

- `apps/server`：本地 API、SQLite、RSS/RSSHub 实例池、AI 与数据库导入。
...
FoLocal 的部分代码基于 [RSSNext/Folo](https://github.com/RSSNext/Folo)（AGPL-3.0），
感谢原项目作者与所有贡献者。“Folo”名称及原项目美术资源归其各自权利人所有。
...
FoLocal 依据 GNU Affero General Public License version 3 发布，完整条款见
